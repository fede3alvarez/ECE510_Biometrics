...
for m = 1:size(Available_images,1)
    ...
    % Guess ranges
    min_iris = round(pupil_radius*1.6);
    max_iris = round(pupil_radius*3.3);
    ...
    % end
    radius_iris_data(:,2) = smoothn(radius_iris_data(:,2));
    ...
    save(save_file_selections,'pupil_radius','iris_radius','-append')

    % Create a new figure for a new image
    f_figure = f_figure + 1;
